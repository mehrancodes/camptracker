...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            // We need these 3 columns to be here for basecamp authorization,
            // Since every USER can have more than 1 account,
            // But they can access all accounts via this token.
            // That's why we can't save these inside accounts table.
            $table->unsignedBigInteger('basecamp_id')->nullable();
